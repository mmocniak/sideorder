...
import { Settings, StopCircle, Users, StickyNote } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-oat-600">Log orders as they come in</p>
        </div>
      ...
      <Dialog open={showSettings} onOpenChange={setShowSettings}>
        <DialogContent>
          ...
          <div className="space-y-4 py-2">
            <div>
              <Label htmlFor="customerCount" className="flex items-center gap-2">
